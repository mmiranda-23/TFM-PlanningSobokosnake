...
(:predicates
    ...
    ;a field that is occupied by the snake, a hole or a closed door
    (blocked ?x - location)
    ;a field that has a point that can be collected by the snake
    (ispoint ?x - location)
    ;a field that is occupied by a box
    (isbox ?x - location)
...
(:action move-fat-snake
    ;move fat (i.e. already eaten something) snake
...
(:action move-fat-snake-and-open-door
    ;move fat snake and press switch button
...
(:action move-fat-snake-and-switch-off
    ;move fat snake and unpress switch button
    :parameters (?head ?newhead ?tail ?newtail ?doorposition - location ?dir - direction)
    :precondition
    (and
        (not (thinsnake ?head))
...
(:action move-fat-snake-and-close-door
    ;move fat snake through door with switch button unpressed. Door will close.
    :parameters (?head ?newhead ?tail ?newtail - location ?dir - direction)
    :precondition
    (and
        (not (thinsnake ?head))
...
(:action move-thin-snake-and-box-close-door
    ;move thin snake through door with switch button unpressed and push box. Door will close
    :parameters (?oldposition ?newposition ?newboxposition ?doorposition - location ?dir - direction)
    :precondition
    (and
        (thinsnake ?oldposition)
...
(:action move-fat-snake-and-box-open-door
    ;move fat snake and push box to a switch button
...
(:action move-fat-snake-and-box-switch-off
    ;move fat snake, unpress switch button and push box
    :parameters (?head ?newhead ?tail ?newtail ?newboxposition ?doorposition - location ?dir - direction)
    :precondition
    (and
        (not (thinsnake ?head))
...
(:action move-fat-snake-and-box-close-door
    ;move snake through door with switch button unpressed and push box. Door will close
    :parameters (?head ?newhead ?tail ?newtail ?newboxposition - location ?dir - direction)
    :precondition
    (and
        (not (thinsnake ?head))
...
(:action move-fat-snake-and-box-to-hole
    ;move fat snake and push box to a hole
    :parameters (?head ?newhead ?tail ?newtail ?newboxposition - location ?dir - direction)
    :precondition
    (and
        (not (thinsnake ?head))
...
(:action move-fat-snake-and-box-to-hole-switch-off
    ;move fat snake, unpress switch button and push box to a hole
    :parameters (?head ?newhead ?tail ?newtail ?newboxposition ?doorposition - location ?dir - direction)
    :precondition
    (and
        (not (thinsnake ?head))
...
(:action move-fat-snake-and-box-to-hole-close-door
    ;move snake through door with switch button unpressed and push box to a hole. Door will close
    :parameters (?head ?newhead ?tail ?newtail ?newboxposition - location ?dir - direction)
    :precondition
    (and
        (not (thinsnake ?head))
...
(:action move-box-and-eat
    ;move fat snake, push box and eat
...
(:action move-box-open-door-and-eat
    ;move fat snake, push box to a switch button and eat
...
(:action move-box-to-hole-and-eat
    ;move fat snake, push box to a hole and eat
    :parameters (?head ?newhead ?newboxposition - location ?dir - direction)
    :precondition
    (and
        (not (thinsnake ?head))
